...
- ⚔️ I backport and maintain **World of Warcraft addons** for **WotLK 3.3.5a**
- 🧙 Main weapon: **Lua** and the **WoW API**
- 🛠️ I take modern addon versions and make them run on legacy clients
- 📜 Currently maintaining: **TradeSkillMaster**, **Postal**, **KiwiFarm** backports
...
|---|---|---|
| 🏦 [**TradeSkillMaster 3.3.5 backport**](https://github.com/Keoo88/TradeSkillMaster-3.3.5-backport) | TSM v4.14.66 for WotLK — auction house scanning, crafting, mailing, groups & more | `Lua` |
| 📬 [**Postal 3.3.5 backport**](https://github.com/Keoo88/Postal-3.3.5-backport) | Enhanced mailbox: OpenAll, Express, QuickAttach, BlackBook & more | `Lua` |
| 💰 [**KiwiFarm 3.3.5 backport**](https://github.com/Keoo88/KiwiFarm-3.3.5-backport) | Gold & loot tracker with instance-reset timer | `Lua` |
| 🤖 [**UwU Logs Discord Ladder Bot**](https://github.com/Keoo88/uwu-logs.xyz-discord-ladder-bot) | Guild ladder in Discord powered by UwU Logs ratings | `Python` |
